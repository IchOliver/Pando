    ...
    <div className="site-header">
      <div className="wrap">
        ...
        {/* <nav className="nav-primary" aria-label="Main" id="genesis-nav-primary">
          ...
          <nav className="nav-primary genesis-responsive-menu" aria-label="Main" id="genesis-nav-primary" style={{display: "block"}}>
            <div className="wrap">
              <ul id="menu-primary-nav" className="menu genesis-nav-menu menu-primary js-superfish" style={{touchAction:'auto'}}>
                <li id="menu-item-764" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-451 current_page_item menu-item-764">
                  <a href="index.html" aria-current="page"><span>Home</span></a>
                </li>
                <li id="menu-item-831" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-831">
                  <a href="product/index.html"><span>Product</span></a>
                </li>
                <li id="menu-item-801" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-801">
                  <a href="blog/index.html"><span>Blog</span></a>
                </li>
                <li id="menu-item-762" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-762">
                  <a href="about-us/index.html"><span>About</span></a>
                </li>
                <li id="menu-item-763" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-763">
                  <a href="contact-us/index.html"><span>Contact</span></a>
                </li>
                <li id="menu-item-338" className="highlight menu-item menu-item-type-custom menu-item-object-custom menu-item-338">
